<?php namespace Modules\Generator\Providers;
...
class GeneratorServiceProvider extends ServiceProvider {
	...
	protected function registerConfig()
	{
		...
		$this->mergeConfigFrom(
		    __DIR__.'/../Config/config.php', 'generator'
		);
	}
	...
	{
		$viewPath = base_path('resources/views/modules/generator');
	...
	{
		$langPath = base_path('resources/lang/modules/generator');
